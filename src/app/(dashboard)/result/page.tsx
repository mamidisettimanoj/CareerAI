...
import { refreshAnalysisAction } from '@/actions/predict';
...
export default async function Result() {
  ...
  // If no result exists yet, run it synchronously once
  if (!engineResult) {
    await refreshAnalysisAction();
    redirect('/result'); // Refresh the page to load the new result
  }
