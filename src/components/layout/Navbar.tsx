        ...
        <div className="container flex h-16 items-center">
          <div className="mr-4 flex">
            ...
            <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
              <Link to="/dashboard" className={cn("transition-colors hover:text-foreground/80", location.pathname === '/dashboard' ? 'text-foreground' : 'text-foreground/60')}>
                Dashboard
              </Link>
              <Link to="/predict" className={cn("transition-colors hover:text-foreground/80", location.pathname === '/predict' ? 'text-foreground' : 'text-foreground/60')}>
                Predict
              </Link>
              <Link to="/calculators" className={cn("transition-colors hover:text-foreground/80", location.pathname.includes('/calculators') ? 'text-foreground' : 'text-foreground/60')}>
                Calculators
              </Link>
              <Link to="/skills" className={cn("transition-colors hover:text-foreground/80", location.pathname.includes('/skills') ? 'text-foreground' : 'text-foreground/60')}>
                Skills
              </Link>
              <Link to="/about" className={cn("transition-colors hover:text-foreground/80", location.pathname === '/about' ? 'text-foreground' : 'text-foreground/60')}>
                About
              </Link>
            </nav>
          </div>
