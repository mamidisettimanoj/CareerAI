                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input value={proj.technologies ? proj.technologies.join(', ') : proj.technology || ''} onChange={(e) => updateProject(proj.id, 'technology', e.target.value)} placeholder="E.g. React, Node, MongoDB" />
                    </div>
                  </div>
