...
export function PredictForm({ initialProfile }: PredictFormProps) {
  ...
  const onSubmit = async (values: z.infer<typeof profileSchema>) => {
    ...
    try {
      ...
      await careerService.generateAnalysis();
            ...
            {step === 1 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input {...form.register('personal.sscPercentage', { valueAsNumber: true })} type="number" step="0.1" min="0" max="100" />
                </div>
              </div>
            )}
            ...
            {step === 2 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input {...form.register('hsc.percentage', { valueAsNumber: true })} type="number" step="0.1" min="0" max="100" />
                </div>
              </div>
            )}
            ...
            {step === 3 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input {...form.register('degree.cgpa', { valueAsNumber: true })} type="number" step="0.1" min="0" max="10" />
                </div>
                <div className="space-y-2">
                  <Label>Degree Percentage (optional)</Label>
                  <Input {...form.register('degree.percentage', { valueAsNumber: true })} type="number" step="0.1" min="0" max="100" />
                </div>
                <div className="space-y-2">
